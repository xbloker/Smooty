...
public class LauncherHelper {
    ...
    private enum Launcher {
        ...
        ZERO, V, ABC, EVIE, POCO, POSIDON, MICROSOFT, FLICK, BLACKBERRY, SQUARE, NIAGARA, CPL
    }
    ...
    private static void applyLauncher(@NonNull Context context, String launcherPackage, String launcherName, Launcher launcher) {
        switch (launcher) {
            ...
            case NOVA:
                ...
                break;
            case CPL:
                applyManual(context, launcherPackage, launcherName, "com.google.android.apps.nexuslauncher.SettingsActivity");
                break;
            case POCO:
